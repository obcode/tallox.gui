...
export type DemandTableQuery = { semesters: Array<{ code: string, phase: Phase, isPlanningSemester: boolean }>, planningSemester: { code: string } | null, me: { roles: Array<Role>, programmes: Array<{ code: string, title: string }>, subjectGroupsLed: Array<{ id: string, code: string, name: string }> } | null, subjectGroups: Array<{ id: string, code: string, name: string }>, programmes: Array<{ code: string, title: string, active: boolean }>, semester?: { code: string, phase: Phase, wishesPublishedAt: string | null }, demandCompletions?: Array<{ completedAt: string, programme: { code: string } }>, modules?: Array<{ id: string, name: string, zpaId: string | null, source: ModuleSource, kind: ModuleKind, active: boolean, contactHoursPerWeek: number | null, splitIsEstimated: boolean, plannable: boolean, practicalKind: InstancePartKind | null, dutyStatus: DutyStatus | null, programmeSemester: number | null, components: Array<{ kind: InstancePartKind, teachingHours: number }>, proposedComponents: Array<{ kind: InstancePartKind, teachingHours: number }> }>, courseInstances?: Array<{ id: string, track: string, programmeSemester: number | null, note: string, teachingHours: number, programme: { code: string, title: string }, module: { id: string, name: string, zpaId: string | null, source: ModuleSource, kind: ModuleKind, splitIsEstimated: boolean, plannable: boolean, practicalKind: InstancePartKind | null, dutyStatus: DutyStatus | null, programmeSemester: number | null, components: Array<{ kind: InstancePartKind, teachingHours: number }>, proposedComponents: Array<{ kind: InstancePartKind, teachingHours: number }> }, parts: Array<{ id: string, kind: InstancePartKind, teachingHours: number | null, sharedAcrossTracks: boolean }>, borrowedParts: Array<{ fromTrack: string, fromProgramme: { code: string } | null, part: { id: string, kind: InstancePartKind, teachingHours: number | null } }>, coveredBy: { acceptedAt: string | null, instance: { id: string, track: string, programmeSemester: number | null, programme: { code: string } } } | null, covers: Array<{ acceptedAt: string | null, instance: { id: string, track: string, programmeSemester: number | null, programme: { code: string } } }>, alsoPlannedSeparately: Array<{ id: string, track: string, programmeSemester: number | null, programme: { code: string } }> }>, foreign?: Array<{ id: string, name: string, zpaId: string | null, source: ModuleSource, kind: ModuleKind, plannable: boolean, homeProgramme: { code: string, title: string } }>, previous?: Array<{ id: string, track: string, programmeSemester: number | null, note: string, teachingHours: number, module: { id: string }, parts: Array<{ id: string, kind: InstancePartKind, teachingHours: number | null, sharedAcrossTracks: boolean }>, borrowedParts: Array<{ fromTrack: string, fromProgramme: { code: string } | null, part: { id: string, kind: InstancePartKind, teachingHours: number | null } }>, coveredBy: { acceptedAt: string | null, instance: { id: string, track: string, programmeSemester: number | null, programme: { code: string } } } | null, covers: Array<{ acceptedAt: string | null, instance: { id: string, track: string, programmeSemester: number | null, programme: { code: string } } }>, alsoPlannedSeparately: Array<{ id: string, track: string, programmeSemester: number | null, programme: { code: string } }> }> };
...
export type PlanDemandMutation = { planDemand: { dryRun: boolean, teachingHours: number, created: Array<{ moduleName: string, track: string }>, withdrawn: Array<{ moduleName: string, track: string }>, coupled: Array<{ moduleName: string, track: string }>, promoted: Array<{ moduleName: string, track: string, programme: { code: string } | null }>, changed: Array<{ moduleName: string, track: string, trackBefore: string | null, groupsBefore: number | null, groupsAfter: number | null }>, refused: Array<{ moduleName: string, track: string, code: string, message: string }> } };
...
export type RequestCoverageFromTableMutationVariables = Exact<{
  id: string | number;
  coveredBy: string | number;
}>;


export type RequestCoverageFromTableMutation = { requestInstanceCoverage: { id: string } };

export type AcceptCoverageFromTableMutationVariables = Exact<{
  id: string | number;
}>;


export type AcceptCoverageFromTableMutation = { acceptInstanceCoverage: { id: string } };

export type ReleaseCoverageFromTableMutationVariables = Exact<{
  id: string | number;
}>;


export type ReleaseCoverageFromTableMutation = { releaseInstanceCoverage: { id: string } };

export type CoverageCandidatesQueryVariables = Exact<{
  semester: string;
  module: string | number;
}>;


export type CoverageCandidatesQuery = { courseInstances: Array<{ id: string, track: string, programmeSemester: number | null, teachingHours: number, programme: { code: string, title: string }, coveredBy: { acceptedAt: string | null } | null, covers: Array<{ acceptedAt: string | null }> }> };
...
export type FileLocalModuleMutationVariables = Exact<{
  moduleIds: Array<string | number> | string | number;
  subjectGroup?: string | number | null | undefined;
}>;


export type FileLocalModuleMutation = { setModulesSubjectGroup: { modulesAssigned: number } };
...
export type OwnCompetencesQueryVariables = Exact<{ [key: string]: never; }>;


export type OwnCompetencesQuery = { mySubjectGroups: Array<{ id: string, code: string, name: string, modules: Array<{ id: string, name: string, homeProgrammeCode: string, compulsory: boolean }> }>, myCompetences: Array<{ id: string, level: CompetenceLevel, note: string, outsideSubjectGroups: boolean, module: { id: string, name: string, compulsory: boolean, subjectGroup: { code: string } | null } }>, myCompetenceStatus: Array<{ canTeachCompulsory: number, minimum: number, subjectGroup: { id: string } }> };

export type MyCompetencesForSavingQueryVariables = Exact<{ [key: string]: never; }>;


export type MyCompetencesForSavingQuery = { myCompetences: Array<{ id: string, level: CompetenceLevel, note: string, module: { id: string } }> };

export type SetMyCompetenceMutationVariables = Exact<{
  module: string | number;
...
export type SetMyCompetenceMutation = { setMyCompetence: { id: string } };

export type WithdrawMyCompetenceMutationVariables = Exact<{
  id: string | number;
}>;


export type WithdrawMyCompetenceMutation = { withdrawMyCompetence: string };

export type MyRolesQueryVariables = Exact<{ [key: string]: never; }>;


export type MyRolesQuery = { me: { id: string, mail: string, name: string, roles: Array<Role>, programmes: Array<{ code: string, title: string }>, subjectGroupsLed: Array<{ id: string, code: string, name: string, active: boolean }> } | null, mySubjectGroups: Array<{ id: string, code: string, name: string }> };
...
export type CompetencePoolQueryVariables = Exact<{
  group: string | number;
  withGroup: boolean;
  search: string;
  withSearch: boolean;
...
export type CompetencePoolQuery = { session: { effectiveRoles: Array<Role> }, subjectGroups: Array<{ id: string, code: string, name: string }>, me: { subjectGroupsLed: Array<{ id: string }> } | null, subjectGroup?: { id: string, code: string, name: string, modules: Array<{ id: string, name: string, homeProgrammeCode: string, compulsory: boolean }> } | null, competences?: Array<{ id: string, level: CompetenceLevel, note: string, module: { id: string }, holder: { personId: string | null, teacherId: string | null, name: string } }>, teachers?: Array<{ id: string, name: string, mail: string | null, isUser: boolean }> };

export type CompetenceGroupCountsQueryVariables = Exact<{
  group: string | number;
}>;


export type CompetenceGroupCountsQuery = { competenceMemberStatus: Array<{ canTeachCompulsory: number, minimum: number, member: { personId: string | null, name: string } }>, modulesWithoutCompetence: Array<{ id: string, name: string, compulsory: boolean }> };

export type SetTeacherCompetenceMutationVariables = Exact<{
  module: string | number;
...
export type SetTeacherCompetenceMutation = { setTeacherCompetence: { id: string } };

export type WithdrawTeacherCompetenceMutationVariables = Exact<{
  id: string | number;
}>;


export type WithdrawTeacherCompetenceMutation = { withdrawTeacherCompetence: string };
...
export const RequestCoverageFromTableDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RequestCoverageFromTable"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"coveredBy"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"requestInstanceCoverage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"coveredBy"},"value":{"kind":"Variable","name":{"kind":"Name","value":"coveredBy"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<RequestCoverageFromTableMutation, RequestCoverageFromTableMutationVariables>;
export const AcceptCoverageFromTableDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AcceptCoverageFromTable"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"acceptInstanceCoverage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<AcceptCoverageFromTableMutation, AcceptCoverageFromTableMutationVariables>;
export const ReleaseCoverageFromTableDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ReleaseCoverageFromTable"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"releaseInstanceCoverage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<ReleaseCoverageFromTableMutation, ReleaseCoverageFromTableMutationVariables>;
export const CoverageCandidatesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"CoverageCandidates"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"semester"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"module"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"courseInstances"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"semester"},"value":{"kind":"Variable","name":{"kind":"Name","value":"semester"}}},{"kind":"Argument","name":{"kind":"Name","value":"module"},"value":{"kind":"Variable","name":{"kind":"Name","value":"module"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"track"}},{"kind":"Field","name":{"kind":"Name","value":"programmeSemester"}},{"kind":"Field","name":{"kind":"Name","value":"teachingHours"}},{"kind":"Field","name":{"kind":"Name","value":"programme"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"title"}}]}},{"kind":"Field","name":{"kind":"Name","value":"coveredBy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"acceptedAt"}}]}},{"kind":"Field","name":{"kind":"Name","value":"covers"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"acceptedAt"}}]}}]}}]}}]} as unknown as DocumentNode<CoverageCandidatesQuery, CoverageCandidatesQueryVariables>;
...
export const OwnCompetencesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"OwnCompetences"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"mySubjectGroups"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"modules"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"homeProgrammeCode"}},{"kind":"Field","name":{"kind":"Name","value":"compulsory"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"myCompetences"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"level"}},{"kind":"Field","name":{"kind":"Name","value":"note"}},{"kind":"Field","name":{"kind":"Name","value":"outsideSubjectGroups"}},{"kind":"Field","name":{"kind":"Name","value":"module"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"compulsory"}},{"kind":"Field","name":{"kind":"Name","value":"subjectGroup"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"code"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"myCompetenceStatus"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"subjectGroup"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"canTeachCompulsory"}},{"kind":"Field","name":{"kind":"Name","value":"minimum"}}]}}]}}]} as unknown as DocumentNode<OwnCompetencesQuery, OwnCompetencesQueryVariables>;
export const MyCompetencesForSavingDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"MyCompetencesForSaving"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"myCompetences"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"level"}},{"kind":"Field","name":{"kind":"Name","value":"note"}},{"kind":"Field","name":{"kind":"Name","value":"module"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}}]} as unknown as DocumentNode<MyCompetencesForSavingQuery, MyCompetencesForSavingQueryVariables>;
export const SetMyCompetenceDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SetMyCompetence"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"module"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"level"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CompetenceLevel"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"note"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"setMyCompetence"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"moduleId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"module"}}},{"kind":"Argument","name":{"kind":"Name","value":"level"},"value":{"kind":"Variable","name":{"kind":"Name","value":"level"}}},{"kind":"Argument","name":{"kind":"Name","value":"note"},"value":{"kind":"Variable","name":{"kind":"Name","value":"note"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<SetMyCompetenceMutation, SetMyCompetenceMutationVariables>;
export const WithdrawMyCompetenceDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"WithdrawMyCompetence"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"withdrawMyCompetence"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<WithdrawMyCompetenceMutation, WithdrawMyCompetenceMutationVariables>;
...
export const CompetencePoolDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"CompetencePool"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"group"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"withGroup"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"search"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"withSearch"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"session"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"effectiveRoles"}}]}},{"kind":"Field","name":{"kind":"Name","value":"subjectGroups"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"me"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"subjectGroupsLed"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"subjectGroup"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"group"}}}],"directives":[{"kind":"Directive","name":{"kind":"Name","value":"include"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"if"},"value":{"kind":"Variable","name":{"kind":"Name","value":"withGroup"}}}]}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"modules"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"homeProgrammeCode"}},{"kind":"Field","name":{"kind":"Name","value":"compulsory"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"competences"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"subjectGroup"},"value":{"kind":"Variable","name":{"kind":"Name","value":"group"}}}],"directives":[{"kind":"Directive","name":{"kind":"Name","value":"include"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"if"},"value":{"kind":"Variable","name":{"kind":"Name","value":"withGroup"}}}]}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"level"}},{"kind":"Field","name":{"kind":"Name","value":"note"}},{"kind":"Field","name":{"kind":"Name","value":"module"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"holder"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"personId"}},{"kind":"Field","name":{"kind":"Name","value":"teacherId"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"teachers"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"search"},"value":{"kind":"Variable","name":{"kind":"Name","value":"search"}}}],"directives":[{"kind":"Directive","name":{"kind":"Name","value":"include"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"if"},"value":{"kind":"Variable","name":{"kind":"Name","value":"withSearch"}}}]}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"mail"}},{"kind":"Field","name":{"kind":"Name","value":"isUser"}}]}}]}}]} as unknown as DocumentNode<CompetencePoolQuery, CompetencePoolQueryVariables>;
export const CompetenceGroupCountsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"CompetenceGroupCounts"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"group"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"competenceMemberStatus"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"subjectGroup"},"value":{"kind":"Variable","name":{"kind":"Name","value":"group"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"member"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"personId"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"canTeachCompulsory"}},{"kind":"Field","name":{"kind":"Name","value":"minimum"}}]}},{"kind":"Field","name":{"kind":"Name","value":"modulesWithoutCompetence"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"subjectGroup"},"value":{"kind":"Variable","name":{"kind":"Name","value":"group"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"compulsory"}}]}}]}}]} as unknown as DocumentNode<CompetenceGroupCountsQuery, CompetenceGroupCountsQueryVariables>;
export const SetTeacherCompetenceDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SetTeacherCompetence"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"module"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"teacher"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"level"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CompetenceLevel"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"note"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"setTeacherCompetence"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"moduleId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"module"}}},{"kind":"Argument","name":{"kind":"Name","value":"teacherId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"teacher"}}},{"kind":"Argument","name":{"kind":"Name","value":"level"},"value":{"kind":"Variable","name":{"kind":"Name","value":"level"}}},{"kind":"Argument","name":{"kind":"Name","value":"note"},"value":{"kind":"Variable","name":{"kind":"Name","value":"note"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<SetTeacherCompetenceMutation, SetTeacherCompetenceMutationVariables>;
export const WithdrawTeacherCompetenceDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"WithdrawTeacherCompetence"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"withdrawTeacherCompetence"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<WithdrawTeacherCompetenceMutation, WithdrawTeacherCompetenceMutationVariables>;