...
export type ModuleQuery = { me: { roles: Array<Role>, programmes: Array<{ code: string }> } | null, module: { id: string, name: string, zpaId: string | null, active: boolean, official: boolean, retiredAt: string | null, courseType: CourseType, frequency: Frequency, contactHoursPerWeek: number | null, credits: number | null, componentHours: number | null, homeProgramme: { code: string, title: string }, responsible: { id: string, name: string, sortName: string, mail: string | null, isProfessor: boolean, isLecturerOnContract: boolean, isHonoraryProfessor: boolean, isStaff: boolean, active: boolean, faculty: string | null, lastSemester: string | null, isUser: boolean } | null, components: Array<{ id: string, kind: InstancePartKind, teachingHours: number, position: number }>, offerings: Array<{ isDuty: boolean, moduleCodes: Array<string>, focuses: Array<string>, minProgrammeSemester: number | null, spo: { id: string, version: number, validFrom: string | null, primussId: string | null, programme: { code: string } } }> } | null };
