...
export type TeacherAccountsQuery = { teacherAccounts: Array<{ teacher: { id: string, name: string, sortName: string, mail: string | null, isProfessor: boolean, isLecturerOnContract: boolean, isHonoraryProfessor: boolean, isStaff: boolean, active: boolean, faculty: string | null, lastSemester: string | null }, account: { id: string, mail: string, active: boolean, roles: Array<Role>, programmes: Array<{ code: string }> } | null }> | null, programmes: Array<{ code: string, title: string, active: boolean }> };
