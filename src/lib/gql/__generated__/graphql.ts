...
export type CatalogueQuery = { programmes: Array<{ code: string, title: string, active: boolean, spos: Array<{ id: string, version: number, primussId: string | null }> }>, modules: Array<{ id: string, name: string, zpaId: string | null, active: boolean, courseType: CourseType, frequency: Frequency, contactHoursPerWeek: number | null, credits: number | null, componentHours: number | null, dutyStatus: DutyStatus | null, inCatalogue: boolean, homeProgramme: { code: string }, components: Array<{ id: string, kind: InstancePartKind, teachingHours: number }> }> };
...
export type ModuleQuery = { me: { roles: Array<Role>, programmes: Array<{ code: string }> } | null, module: { id: string, name: string, zpaId: string | null, active: boolean, official: boolean, retiredAt: string | null, courseType: CourseType, frequency: Frequency, contactHoursPerWeek: number | null, credits: number | null, componentHours: number | null, homeProgramme: { code: string, title: string }, components: Array<{ id: string, kind: InstancePartKind, teachingHours: number, position: number }>, offerings: Array<{ isDuty: boolean, moduleCodes: Array<string>, focuses: Array<string>, minProgrammeSemester: number | null, spo: { id: string, version: number, validFrom: string | null, primussId: string | null, programme: { code: string } } }> } | null };
...
export type PeopleQuery = { people: Array<{ id: string, mail: string, name: string, roles: Array<Role>, programmes: Array<{ code: string }> }> | null, programmes: Array<{ code: string, title: string, active: boolean }> };
